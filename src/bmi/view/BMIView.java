...
public class BMIView extends JFrame {
	...
	JTextField tfWeight, tfHeight; // 텍스트 필트 : 체중 입력, 키 입력 
	...
	class PanelBelow extends JPanel {
		public PanelBelow(){
			...
			setLayout(new BorderLayout());
			lblResult = new JLabel("<html>당신의 체중은 -kg, 키는 _cm이므로 <br>bmi지수는 _kg/㎡이며, __체중입니다.</html>", JLabel.CENTER);
	...
	ActionListener btnL = new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			...
			lblResult.setText("<html>당신의 체중은"+vo.getWeight()+"kg, 키는 "+vo.getHeight()+"cm이므로 <br>bmi지수는 "
			+String.format("%.1f",vo.getBmi())+"kg/㎡이며,"+bmiResult+"체중입니다.</html>");
